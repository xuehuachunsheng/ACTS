...
parser = argparse.ArgumentParser(description="CIFAR-100 LPSL Running")
...
train_loss_file = "/home/wyx/vscode_projects/hier/models/CIFAR100/train_loss_lpsl_lambda{}eta{}.csv".format(lambda1,lambda2)
val_loss_file = "/home/wyx/vscode_projects/hier/models/CIFAR100/val_loss_lpsl_lambda{}eta{}.csv".format(lambda1,lambda2)
test_acc_file = "/home/wyx/vscode_projects/hier/models/CIFAR100/test_acc_lpsl_lambda{}eta{}.csv".format(lambda1,lambda2)
best_model_path = "/home/wyx/vscode_projects/hier/models/CIFAR100/best_model_lpsl_lambda{}eta{}.pth".format(lambda1,lambda2)
...
# 读取数据
dataset_train = CIFAR100Dataset(train=True, HLevel=HLevel, image_size=224)
dataset_test = CIFAR100Dataset(train=False, HLevel=HLevel, image_size=224)
