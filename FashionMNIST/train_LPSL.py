...
train_loss_file = "/home/wyx/vscode_projects/hier/models/FashionMNIST/train_loss_lpsl_lambda{}eta{}.csv".format(lambda1,lambda2)
val_loss_file = "/home/wyx/vscode_projects/hier/models/FashionMNIST/val_loss_lpsl_lambda{}eta{}.csv".format(lambda1,lambda2)
test_acc_file = "/home/wyx/vscode_projects/hier/models/FashionMNIST/test_acc_lpsl_lambda{}eta{}.csv".format(lambda1,lambda2)
best_model_path = "/home/wyx/vscode_projects/hier/models/FashionMNIST/best_model_lpsl_lambda{}eta{}.pth".format(lambda1,lambda2)
...
# 读取数据
dataset_train = FashionMNISTDataset(train=True, HLevel=HLevel, image_size=224)
dataset_test = FashionMNISTDataset(train=False, HLevel=HLevel, image_size=224)
