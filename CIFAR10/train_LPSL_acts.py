...
parser = argparse.ArgumentParser(description="CIFAR10 LPSL ACTS Running")
...
train_loss_file = "/home/wyx/vscode_projects/hier/models/CIFAR10/acts_train_loss_lpsl_acts_delta{}T{}.csv".format(args.delta,args.T1)
val_loss_file = "/home/wyx/vscode_projects/hier/models/CIFAR10/acts_val_loss_lpsl_acts_delta{}T{}.csv".format(args.delta,args.T1)
test_acc_file = "/home/wyx/vscode_projects/hier/models/CIFAR10/acts_test_acc_lpsl_acts_delta{}T{}.csv".format(args.delta,args.T1)
best_model_path = "/home/wyx/vscode_projects/hier/models/CIFAR10/acts_best_model_lpsl_delta{}T{}.pth".format(args.delta,args.T1)
acts_out_path = "/home/wyx/vscode_projects/hier/models/CIFAR10/acts_Q_delta{}T{}.csv".format(args.delta,args.T1)
...
# 读取数据
dataset_L,dataset_U = CIFAR10DatasetAL.createLURandomly(HLevel=HLevel,image_size=32)
dataset_test = CIFAR10Dataset(train=False, HLevel=HLevel, image_size=32)
...
_acts_ = Acts(dataset_L, dataset_U, 
              ...
              args.q_budget, 
              DEVICE, 
              CIFAR10Dataset.CLASS_HIERARCHY, 
              delta=args.delta, 
              m=E1-1, 
              T1=args.T1, 
              Tm=0.001,
